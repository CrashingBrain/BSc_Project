...
%\draw [brace] (rinf.north) -- node [blabel] {\footnotesize arbitrarily large} (inf.north);
\draw [->, dotted, thick, red, rounded corners=3pt] ($(skr.north)+(0,0.3)$) |- node [above left] {\footnotesize wanted} ($(Start.north)+(0,0.5)$);
\end{tikzpicture}