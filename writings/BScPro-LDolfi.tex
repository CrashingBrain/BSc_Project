...
after an explanation of the motivation of the search, chapter \ref{ch:two} explains the basics of key exchange in both classical and quantum mechanical frameworks.
 ...
 Chapter \ref{ch:five} summarises the state of research on bound information and finally chapter \ref{ch:six} presents the numerical analysis conducted on probability distributions.
%\end{abstract}
